...
def get_args():
    ...
    #parser.add_argument('-rd', '--roidir', type=str, default='/mnt/disk1/AiCity22/', help="Region of Interest images directory.")
    return parser.parse_args()


def usageMsg():
    return """  python3 eval.py <ground_truth> <prediction>
...
if __name__ == '__main__':
    ...
    try:
        summary = eval(test, pred, mread=args.mread, dstype=args.dstype, roidir=None)
